 ...
 */
require_once 'Dope/Json/Client/Response.php';
    ...
    public function call($method, $params=array())
    {
        if (!$this->skipSystemLookup() && !empty($method)) {
            ...
            foreach ($params as $key => $param) {
                ...
                if($keyFound !== true) {
                    throw new Client\FaultException("named parameter $key not found in SMD");
                }
            }
        }
        ...
        if ($this->_lastResponse->isError()) {
             ...
             * @see \Dope\Json\Client\FaultException
             */
            throw new Client\FaultException($fault->getMessage(), $fault->getCode());
        }
